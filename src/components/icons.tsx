...
const paths: Record<string, React.ReactNode> = {
  ...
  flask: (
    <>
      <path d="M10 2v7.31L4.68 16.9A2.5 2.5 0 0 0 6.9 20.5h10.2a2.5 2.5 0 0 0 2.22-3.6L14 9.31V2" />
  ...
  balance: (
    <>
      <path d="M12 3v18M5 21h14M7 21V10M17 21V10M2 10h20l-3-4h-14z" />
      <path d="m6 10-2-3M18 10l-2-3" />
    </>
  ),
  mail: (
    <>
  ...
  external: (
    <>
      <path d="M15 3h6v6" />
      <path d="M10 14 21 3M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
    </>
  ),
  menu: (
    <>
